<template>
  <el-card>
    <h1 class="me-author-name">土豆条</h1>
    <div class="me-author-description">
      <span><i class="el-icon-location-outline"></i> &nbsp;北京&朝阳</span>
      <span><i class="me-icon-job"></i> &nbsp;Java后端</span>
    </div>
...
<script>
  export default {
    ...
    data() {
      return {
        qq: {title: 'QQ', message: '1292748978'},
        bilibili: {
          title: '哔哩哔哩',
          message: '<a target="_blank" href="✌bilibili✌">✌bilibili✌</a>'
        }
      }
    },
    methods: {
